...
angular.module('proyectoClinicaApp')
  .controller('PreguntaestudianteCtrl', function ($scope, $http) {
    $http.get('/api/preguntaestudiante').success(function(listaPregunta) {
    ...
    $scope.guardar = function (preguntaIngreso){
      $http({
        method: 'POST',
        url: '/api/preguntaestudiante/guardar',
        params:
        {
    ...
    $scope.eliminarPregunta = function(id){
      $http({
        method: 'POST',
        url: '/api/preguntaestudiante/eliminar',
        params: {
          _id: id
        }
      }).
    ...
    $scope.editar = function(pregunta){
      $http({
        method:'POST',
        url: '/api/preguntaestudiante/editar/',
        params:{
          id: pregunta.id,
